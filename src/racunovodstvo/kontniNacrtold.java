...
public class kontniNacrtold extends javax.swing.JFrame {

    /**
     * Creates new form kontniNacrt
     */
    public kontniNacrtold() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kontniNacrtold.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {           
            public void run() {               
                new kontniNacrtold().setVisible(true);                
            }
        });
    }
